...
从git
server网站上取得ucore_lab后，进入目录labcodes/lab4，完成实验要求的各个练习。在实验报告中回答所有练习中提出的问题。在目录labcodes/lab4下存放实验报告，实验报告文档命名为lab4-学生ID.md。推荐用\ **markdown**\ 格式。对于lab4中编程任务，完成编写之后，再通过git
